...
import com.minecraft.job.api.controller.dto.ReviewGetListDto.ReviewGetListRequest;
...
import static com.minecraft.job.common.review.domain.ReviewSearchType.ALL;
...
class ReviewApiTest extends ApiTest {
    ...
    void 리뷰_목록_조회_성공() throws Exception {
        ReviewGetListRequest req = new ReviewGetListRequest(ALL, "", 0, 10);
